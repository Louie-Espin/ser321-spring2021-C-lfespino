    ...
    try {
      ...
      if (request == null) {
        ...
        if (request.length() == 0) {
          ...
          // DONE: Include error handling here with a correct error code and
          ...
          try {
            ...
            builder.append("LENGTH: " + repoArray.length());
           ...
           for(int i=0; i<repoArray.length(); i++){
            ...
            builder.append("Owned by: " + ownername);
            builder.append("\n");
            
            // get repo id
            JSONObject repoID = repo.getJSONObject("id");
            String IdNum = repoID.getString("login");
            builder.append("REPO ID: " + IdNum);
            builder.append("\n");
         ...
         builder.append("HTTP/1.1 500 BAD\n");
        }
        } else {
